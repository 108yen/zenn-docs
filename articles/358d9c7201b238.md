...
Web サイトのバージョン管理に[changesets](https://github.com/changesets/changesets)を導入してみたところ、めちゃめちゃ便利なことがわかりました。ただ、ドキュメントがわかりにくかったので、使い方やつまった点など書いていこうと思います。
...
長くなりましたが、使いこなせるとバージョン管理をほとんど自動化できるので、ぜひ使ってみてください。GitHub Actionの機能など紹介しきれなかった機能もあるので、興味があれば調べてみてください！